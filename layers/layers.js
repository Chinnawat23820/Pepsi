...
lyr_GoogleMaps_0.setVisible(true);lyr_female_cleaned_1.setVisible(true);lyr_male_cleaned_2.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_female_cleaned_1,lyr_male_cleaned_2];
